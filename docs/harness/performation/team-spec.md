...
- SNS source unavailable or login-gated: use only public search result metadata/snippets and present official SNS links as latest-check channels, not as directly crawled data.
